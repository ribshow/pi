...
<template id="my-chats-sci">
<div class="container-chat">
        <div class="chat">
            <div id="chat-box" class="chat-box flex flex-col gap-4">
            @if(!empty($dataSci))
                <div class="delete-all">
                    <form id="chat-delete-all" action="{{route('chat.sci.deleteall')}}" method="POST">
                        @csrf
                        @method('DELETE')
                ...
                <div class="chat-message">
                    ...
                    <div class="chat-delete">
                        <form id="chat-delete" action="{{route('chat.sci.delete', $chat['id'])}}" method="POST">
                            @csrf
                            @method('DELETE')
