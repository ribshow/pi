...
<template id="my-chats-geek">
<div class="container-chat">
        <div class="chat">
            <div id="chat-box" class="chat-box flex flex-col gap-4">
            @if(!empty($dataGeek))
                <div class="delete-all">
                    <form id="chat-delete-all" action="{{route('chat.geek.deleteall')}}" method="POST">
                        @csrf
                        @method('DELETE')
                ...
                <div class="chat-message">
                    ...
                    <div class="chat-delete">
                        <form id="chat-delete" action="{{route('chat.geek.delete', $chat['id'])}}" method="POST">
                            @csrf
                            @method('DELETE')
